...
local function handle_post_match()
    ...
    local post_data = {
        username = "PHAX",
        avatar_url = "https://cdn.discordapp.com/attachments/1451836764498169958/1455842441084014703/standard2.gif?ex=6956326e&is=6954e0ee&hm=9db4141608b5bec1a140f7b1117613921cc7e7f5c8484358e69bc0dd731686c5&",
        embeds = {{
            ...
            thumbnail = { url = "https://cdn.discordapp.com/attachments/1451836764498169958/1455842221784830097/standard1.gif?ex=69563239&is=6954e0b9&hm=1214d2605c3138c291f6e315b3fa95808964f845b467b0a86ba0bd0ad1864803&" }, -- banner GIF or image
            fields = {
                {
            ...
            footer = {
                text = "Logged for " .. local_player.Name .. " • PHS | PASH"
            },
...
local function log_match_start()
    ...
    local start_payload = {
        ...
        embeds = {{
            ...
            description = "PHS is ready and loaded into a new match. 🎮\nSit back while the auto-strategy runs seamlessly!",
            ...
            fields = {
                ...
                {
                    name = "💡 Tip",
                    value = "PHS will handle your strategy automatically. Keep an eye on resources for maximum efficiency!",
                    inline = false
                }
            },
            footer = {
                text = "Logged for " .. local_player.Name .. " • PHAX"
            },
            timestamp = DateTime.now():ToIsoDate()
        }}
    }
